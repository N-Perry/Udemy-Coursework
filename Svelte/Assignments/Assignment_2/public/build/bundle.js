...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*userPassword*/ 1) set_data_dev(t, /*userPassword*/ ctx[0]);
    		},
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*passwordList*/ 2 && t0_value !== (t0_value = /*password*/ ctx[8].userPassword + "")) set_data_dev(t0, t0_value);
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*userPassword*/ ctx[0] === "") return create_if_block;
    		if (/*tooShort*/ ctx[3]) return create_if_block_1;
    		if (/*tooLong*/ ctx[2]) return create_if_block_2;
    	...
    	const get_key = ctx => /*password*/ ctx[8].id;
    	...
    	const block = {
    		c: function create() {
    			...
    			button.textContent = "Add To Array";
    			t19 = space();
    			ul = element("ul");
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*addPassword*/ ctx[4], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*deletePassword, passwordList*/ 34) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const click_handler = index => deletePassword(index);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('tooLong' in $$props) $$invalidate(2, tooLong = $$props.tooLong);
    		if ('tooShort' in $$props) $$invalidate(3, tooShort = $$props.tooShort);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*userPassword*/ 1) {
    			$$invalidate(3, tooShort = userPassword.length < 5);
    		}

    		if ($$self.$$.dirty & /*userPassword*/ 1) {
    			$$invalidate(2, tooLong = userPassword.length > 10);
    		}
    	};
