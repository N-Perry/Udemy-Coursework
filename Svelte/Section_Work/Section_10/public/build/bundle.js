...
var app = (function () {
    ...
    // (41:2) <Button mode="outline" on:click={displayDescription}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(41:2) <Button mode=\\\"outline\\\" on:click={displayDescription}>",
    		ctx
    	});
    ...
    // (44:2) <Button on:click={removeFromCart}>
    function create_default_slot$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(44:2) <Button on:click={removeFromCart}>",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 45, 4, 1223);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(45:2) {#if showDescription}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 38, 2, 965);
    			attr_dev(h2, "class", "svelte-1td7xux");
    			add_location(h2, file$3, 39, 2, 984);
    			attr_dev(li, "class", "svelte-1td7xux");
    			add_location(li, file$3, 37, 0, 958);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 37, 6, 660);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    // (35:4) {#each $cartItems as item (item.id)}
    function create_each_block$1(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(35:4) {#each $cartItems as item (item.id)}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 32, 2, 510);
    			attr_dev(ul, "class", "svelte-1c2znv1");
    			add_location(ul, file$2, 33, 2, 526);
    			attr_dev(section, "class", "svelte-1c2znv1");
    			add_location(section, file$2, 31, 0, 498);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 27, 4, 499);
    			attr_dev(h2, "class", "svelte-9ht2za");
    			add_location(h2, file$1, 28, 4, 520);
    			attr_dev(p, "class", "svelte-9ht2za");
    			add_location(p, file$1, 29, 4, 541);
    			add_location(div0, file$1, 26, 2, 489);
    			add_location(div1, file$1, 31, 2, 573);
    			attr_dev(div2, "class", "product svelte-9ht2za");
    			add_location(div2, file$1, 25, 0, 465);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	function addToCart() {
    		//cartItems.set([]);
    		cart.update(currentStoreData => {
    			return [...currentStoreData, { id, title, price }];
    		});
    	}
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 21, 2, 377);
    			attr_dev(section, "class", "svelte-o8blwk");
    			add_location(section, file, 20, 0, 365);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
