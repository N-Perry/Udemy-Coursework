...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 29, 6, 513);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 24, 2, 368);
    			attr_dev(ul, "class", "svelte-1c2znv1");
    			add_location(ul, file$2, 25, 2, 384);
    			attr_dev(section, "class", "svelte-1c2znv1");
    			add_location(section, file$2, 23, 0, 356);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	cart.subscribe(storeData => {
    		$$invalidate(0, items = storeData);
    	});
