...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$4, 43, 4, 1164);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(43:2) {#if showDescription}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 36, 2, 906);
    			attr_dev(h2, "class", "svelte-1td7xux");
    			add_location(h2, file$4, 37, 2, 925);
    			attr_dev(li, "class", "svelte-1td7xux");
    			add_location(li, file$4, 35, 0, 899);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 43, 6, 800);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    // (41:4) {#each $cartItems as item (item.id)}
    function create_each_block$1(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(41:4) {#each $cartItems as item (item.id)}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 38, 2, 650);
    			attr_dev(ul, "class", "svelte-1c2znv1");
    			add_location(ul, file$3, 39, 2, 666);
    			attr_dev(section, "class", "svelte-1c2znv1");
    			add_location(section, file$3, 37, 0, 638);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 17, 4, 318);
    			attr_dev(h2, "class", "svelte-9ht2za");
    			add_location(h2, file$2, 18, 4, 339);
    			attr_dev(p, "class", "svelte-9ht2za");
    			add_location(p, file$2, 19, 4, 360);
    			add_location(div0, file$2, 16, 2, 308);
    			add_location(div1, file$2, 21, 2, 392);
    			attr_dev(div2, "class", "product svelte-9ht2za");
    			add_location(div2, file$2, 15, 0, 284);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 21, 2, 377);
    			attr_dev(section, "class", "svelte-o8blwk");
    			add_location(section, file$1, 20, 0, 365);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (15:0) <Button mode="test" on:click={() => (showCart = !showCart)}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(15:0) <Button mode=\\\"test\\\" on:click={() => (showCart = !showCart)}>",
    		ctx
    	});
